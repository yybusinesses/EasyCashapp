...
import { DollarSign, MapPin, Briefcase, PenTool, Truck, Sparkles } from 'lucide-react'
            ...
            <Card className="w-full h-full overflow-hidden shadow-lg rounded-2xl bg-white">
              ...
              <CardContent className="p-4 text-center">
                <div className="flex justify-center mb-4">
                  {jobs[currentIndex].icon && <jobs[currentIndex].icon className="w-12 h-12 text-blue-500" />}
                </div>
